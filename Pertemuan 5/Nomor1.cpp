...
void faktorbilanganPrima (int bilanganPrima){ //Menghitung faktor bilangan Prima
...
void faktorbilanganGanjil (int bilanganGanjil){ //Menghitung faktor bilangan Ganjil
...
void faktorbilanganGenap (int bilanganGenap){ //Menghitung faktor bilangan Genap
...
int main(){
 ...
 int sumGenap = 0;
    ...
    bilGanjil (bilangan, sumGanjil); //Function menampilkan bilangan Ganjil
